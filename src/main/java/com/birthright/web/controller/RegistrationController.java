...
public class RegistrationController {
    ...
    @Autowired
    public RegistrationController(ApplicationEventPublisher eventPublisher, IUserService userService, IVerificationTokenService tokenService, ISecureService secureService, @Qualifier("messageSource") MessageSource messages, EmailMessageSender emailMessageSender, LocaleResolver localeResolver) {
    ...
    public String resendRegistrationToken(final @SessionAttribute(value = SessionConstants.EXISTING_TOKEN, required = false) String existingToken,
        ...
        if (existingToken != null) {
            ...
            String appUrl = ApplicationHelper.getAppUrl(request);
            try {
                emailMessageSender.resendVerificationTokenEmail(appUrl, locale, newToken, newToken.getUser());
